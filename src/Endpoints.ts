...
export default {
    ...
    COMMUNITY_ONLINE_MEMBERS: (ndcId: number, start: number, size: number) => `https://service.narvii.com/api/v1/x${ndcId}/s/live-layer?topic=ndtopic%3Ax${ndcId}%3Aonline-members&start=${start}&size=${size}`,
